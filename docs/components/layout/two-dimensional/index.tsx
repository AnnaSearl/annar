  ...
  return (
    <Frame padding>
      <Block noTitlePadding title="Basic" className="demo-grid">
        ...
        <Grid data={data1} columns={3} render={renderGridItem} />
      </Block>
      <Block noTitlePadding title="Gutter" className="demo-grid">
        <Grid data={data2} columns={3} render={renderGridItem} gutter={16} />
        <View className="space" />
        <Grid data={data} columns={3} render={renderGridItem} gutter={[8, 8]} />
      </Block>
      <Block noTitlePadding title="Span" className="demo-grid">
        <Grid data={data3} columns={3} render={renderGridItem} span={16} />
        <View className="space" />
        <Grid data={data3} columns={3} render={renderGridItem} span={-16} />
        <View className="space" />
        <Grid data={data4} columns={3} render={renderGridItem} span={[8, 16, 8, 16]} />
      </Block>
    </Frame>
  );
};
